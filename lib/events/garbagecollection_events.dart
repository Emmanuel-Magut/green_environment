...
import 'package:green_environment/events/post_cleanup_events.dart';
...
class CleanUpEvents extends StatefulWidget {
  const CleanUpEvents({Key? key}) : super(key: key);

  @override
  State<CleanUpEvents> createState() => _CleanUpEventsState();
}

class _CleanUpEventsState extends State<CleanUpEvents> {
  ...
  void rSVP(String eventId) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Will You attend this Clean Up Event?"),
        actions: [
          //CANCEL BUTTON
          TextButton(
          ...
          TextButton(
            onPressed: () async {
              ...
              DocumentSnapshot eventDocument = await FirebaseFirestore.instance.collection('garbage_collection').doc(eventId).get();
              if (eventDocument.exists) {
                // Add currentUser.email to attendees list
                await FirebaseFirestore.instance.collection('garbage_collection').doc(eventId).update({
...
//cancel event
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                decoration: const InputDecoration(labelText: 'Amount of waste collected in Kg'),
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body:_buildCleanUpEvents(currentUser.email!),
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) =>const PostCleanUp(),
              ),
            );
          },
          child: const Column(
  ...
  Widget _buildCleanUpEvents(String currentUserEmail) {
          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildCleanUpEventsGridItem(snapshot.data!.docs[index]);
              },
            );
          },
        );
  ...
  Widget _buildCleanUpEventsGridItem(DocumentSnapshot document) {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: data['imageUrl'] != null && data['imageUrl'] != ''
                  ...
                  height: 150,
                  width: MediaQuery.of(context).size.width,
                  child: Image.asset('lib/images/waste.jpg',
                    width: MediaQuery.of(context).size.width,
                    height: 120,
                  ),
                ),
              ...
              if(data['event_status'] == 'Closed')
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        const Text("Waste Collected in Kgs:",
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 18,
                          ),
    ...
    try {
      ...
      for (DocumentSnapshot eventDocument in upcomingEventsSnapshot.docs) {
        ...
        if (eventData != null) {
          ...
          String title = 'Tomorrow is Garbage Collection Day!';
